...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    const targetY = (this.viewport.height * (980 * this.scale)) / this.screen.height;
    const targetX = (this.viewport.width * (760 * this.scale)) / this.screen.width;
    if (this.borderRadius >= 0.49) {
      const size = Math.min(targetX, targetY);
      this.plane.scale.y = size;
      this.plane.scale.x = size;
    } else {
      this.plane.scale.y = targetY;
      this.plane.scale.x = targetX;
    }
